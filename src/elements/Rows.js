...
class Rows extends React.Component{
    ...
    render(){
        const {id,taskName,taskFrom,assignedDate,dueDate,priority,status,notes,comments} = this.props
        return(
        <tbody>
        <tr>
            <td>{taskName}</td>
            ...
            <Modal
                ...
                <input type='button' value='Emergency'></input>
                <input type='button' value='High'></input>
                <input type='button' value='Medium'></input>
                <input type='button' value='Low'></input>
            </Modal>
        </tr>
        </tbody>)
    }
